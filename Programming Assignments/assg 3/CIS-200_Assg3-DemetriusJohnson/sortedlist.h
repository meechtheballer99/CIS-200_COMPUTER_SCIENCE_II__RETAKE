...
public:
	...
	SortedList<ItemType>& operator=(SortedList<ItemType>& x); // equal sign operator with deep copy
	...
	void Insert(ItemType comparison_item);  // if item is not in the list, insert it into the list
